public:
	...
	/**
	 * @brief Enumerates over entities in a sphere.
	 *
	 * @param pos           Starting position of the ray.
	 ...
	 * @param data          Arbitrary data value to pass through to the enumerator.
	 */
	static void TR_EnumerateEntitiesSphere(const float pos[3], float radius, int mask, TraceEntityEnumeratorFunc enumerator,
		void* data = nullptr)
	{
		s_TraceEntityEnumeratorData[s_TraceEntityEnumeratorIndex] = data;
		s_TraceEntityEnumeratorCallbacks[s_TraceEntityEnumeratorIndex] = enumerator;

		PushArg(s_TR_EnumerateEntitiesSphereFunc, pos, 3);
		PushArg(s_TR_EnumerateEntitiesSphereFunc, radius);
		PushArg(s_TR_EnumerateEntitiesSphereFunc, mask);
		PushArg(s_TR_EnumerateEntitiesSphereFunc, s_TraceEntityEnumeratorIndex);
		++s_TraceEntityEnumeratorIndex;
		ExecFunc(s_TR_EnumerateEntitiesSphereFunc);
	}

	/**
	 * @brief Enumerates over entities in a box.
	 *
	 ...
	 * @param data          Arbitrary data value to pass through to the enumerator.
	 */
	static void TR_EnumerateEntitiesBox(const float mins[3], const float maxs[3], int mask, TraceEntityEnumeratorFunc enumerator,
		void* data = nullptr)
	{
		s_TraceEntityEnumeratorData[s_TraceEntityEnumeratorIndex] = data;
		s_TraceEntityEnumeratorCallbacks[s_TraceEntityEnumeratorIndex] = enumerator;

		PushArg(s_TR_EnumerateEntitiesBoxFunc, mins, 3);
		PushArg(s_TR_EnumerateEntitiesBoxFunc, maxs, 3);
		PushArg(s_TR_EnumerateEntitiesBoxFunc, mask);
		PushArg(s_TR_EnumerateEntitiesBoxFunc, s_TraceEntityEnumeratorIndex);
		++s_TraceEntityEnumeratorIndex;
		ExecFunc(s_TR_EnumerateEntitiesBoxFunc);
	}

	/**
	 * @brief Enumerates over entities at point.
	 *
	 ...
	 * @param data          Arbitrary data value to pass through to the enumerator.
	 */
	static void TR_EnumerateEntitiesPoint(const float pos[3], int mask, TraceEntityEnumeratorFunc enumerator, void* data = nullptr)
	{
		s_TraceEntityEnumeratorData[s_TraceEntityEnumeratorIndex] = data;
		s_TraceEntityEnumeratorCallbacks[s_TraceEntityEnumeratorIndex] = enumerator;

		PushArg(s_TR_EnumerateEntitiesPointFunc, pos, 3);
		PushArg(s_TR_EnumerateEntitiesPointFunc, mask);
		PushArg(s_TR_EnumerateEntitiesPointFunc, s_TraceEntityEnumeratorIndex);
		++s_TraceEntityEnumeratorIndex;
		ExecFunc(s_TR_EnumerateEntitiesPointFunc);
	}
